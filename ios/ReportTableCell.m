...
- (void)setTextPaddingHorizontal:(NSInteger)textPaddingHorizontal {
    ...
    [self.contentView addConstraints:@[
                                ...
                                [NSLayoutConstraint constraintWithItem:self.label attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeRight multiplier:1.0 constant: _lockImageView ? - marginHor * 2 - 14 : - marginHor],
