...
RCT_EXPORT_VIEW_PROPERTY(frozenAbility, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(replenishColumnsWidthConfig, NSDictionary)
RCT_EXPORT_VIEW_PROPERTY(ignoreLocks, NSArray)
