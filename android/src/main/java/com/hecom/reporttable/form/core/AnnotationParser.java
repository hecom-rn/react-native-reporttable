...
import com.hecom.reporttable.form.annotation.ColumnType;
import com.hecom.reporttable.form.annotation.SmartColumn;
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(com.hecom.reporttable.form.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    com.hecom.reporttable.form.annotation.SmartTable table = (com.hecom.reporttable.form.annotation.SmartTable) tableAnnotation;
